...
class RoundedLoginWindow(QMainWindow):
    def __init__(self):
        super(RoundedLoginWindow, self).__init__()
        ...
        # 左侧轮播图区域
        image_paths = ["1.jpg", "4.jpg", "服装2.jpg"]  # 替换为实际图片路径
