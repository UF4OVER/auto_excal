...
class PageMusicPage(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        self.titled_widgets_group = QWidget(self)
        self.titled_widgets_group.setStyleSheet("background-color: #ffffff")
        # self.titled_widgets_group.setSiliconWidgetFlag(Si.EnableAnimationSignals)

        self.scroll_container = SiDenseHContainer(self)
    ...
    #     self.displayer_container = SiDenseContainer(self)
    #
    #
    #     mp3_files = []
    ...
    #         self.titled_widgets_group.(self.displayer_container)
    #         self.titled_widgets_group.adjustSize()
    #
    # def AddMusic(self):
